...
# Download and save the model and scaler locally
...
def explain_prediction(input_data, final_result):
    ...
    for i, feature in enumerate(input_data.columns):
        explanation_text += f"- **{feature}**: Contribution = {shap_values[0][0][i]:.2f}\n"
...
def main():
    ...
    if st.button("Predict"):
        ...
        st.success(f'Your loan is {result}' if result == "Approved" else f'Your loan is {result}')
