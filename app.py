...
def prediction(Credit_History, Education_1, ApplicantIncome, CoapplicantIncome, Loan_Amount_Term):
    ...
    input_data_filtered = input_data_scaled[trained_features]
...
def explain_prediction(input_data, final_result):
    ...
    shap_values = explainer(input_data)  # Generate SHAP values

    # Extract feature contributions
    shap_values_for_input = shap_values.values[0]  # First row corresponds to the single prediction
